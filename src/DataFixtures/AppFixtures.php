...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $manager->flush();
        $manager->getConnection()->exec('INSERT INTO heures_resa (id, id_eléve, id_monuteur, date, résa_heure_conduite, prix, number_heure_total) VALUES (1, 1, 1, \'2023-03-03 08:09:37\', \'2023-03-03 08:09:37\', NULL, 1)');
    }
}
